...
var auth_vue = auth_vue||{}
 auth_vue = { 
	...
	join_body:()=>{
		...
		'        </div>'+
		'+        <div class="mb-3">'+
		'          <label for="pwd">비밀번호 <span class="text-muted"></span></label>'+
		...
		'+       <div class="mb-3">'+
		'          <label for="birth">주소 <span class="text-muted">(Optional)</span></label>'+
		'          <input type="text" class="form-control" id="adress" placeholder="you@example.com">'+
		'          <div class="invalid-feedback">'+
